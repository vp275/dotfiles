...
```bash
ssh -i ~/.ssh/id_ed25519 vp@195.201.139.219 'zsh -lic "command -v nvim ranger bat btop tmux"'
ssh -i ~/.ssh/id_ed25519 vp@195.201.139.219 'sudo chsh -s /usr/bin/zsh vp'
ssh -i ~/.ssh/id_ed25519 vp@195.201.139.219 'printf "%s\\n" "$SHELL"; zsh -lic "echo zsh-ready"'
```
